...
export async function newCommand() {
  ...
  const devopsTools = ['docker','kubernetes','terraform','ansible','helm','nginx','traefik','redis','kafka','rabbitmq','celery','argo-cd']
  ...
  const monitoringTools = ['sentry','grafana','datadog','opentelemetry','jaeger','elastic-apm','firebase-crashlytics','firebase-analytics']
...
`)
  ...
  // 14. Kafka docker-compose service snippet
