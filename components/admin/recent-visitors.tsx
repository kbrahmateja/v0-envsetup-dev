...
export async function RecentVisitors() {
  ...
  let visitors: { page_url: string; country: string | null; city: string | null; visited_at: string }[] = []
  ...
  try {
    visitors = (await sql`
      ...
      LIMIT 10
    `) as { page_url: string; country: string | null; city: string | null; visited_at: string }[]
  } catch (error) {
